{
	...
	"target": "http://bofip.impots.gouv.fr/bofip/",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	"translatorType": 4,
	"browserSupport": "g",
	"lastUpdated": "2012-12-03 11:21:03"
}
...
creators         : FW.Xpath('//td[@class="texteGris"]').text().remove(/©/).cleanAuthor("author","false"),
publicationTitle : "Bulletin officiel des Finances Publiques-Impôts",
callNumber   	 : FW.Xpath('/html/body/div[2]/div[2]/table[2]/tbody/tr/td[2]/div/div/div[2]/div[3]/div').text(),
title            : FW.Xpath('//p[@class="titre-du-document-western"]').text(),
rights		     : 'public',
language	     : 'fre',
ISSN 			 : '2262-1954',
date	    	 :  FW.Xpath('//span[@id="date_publication"]').text(),
});
...
publicationTitle : "Bulletin officiel des Finances Publiques-Impôts",
title            : FW.Xpath('//*[@id="titre-actualite"]').text().remove(/(.*)/),
rights		     : 'public',
language	     : 'fre',
ISSN 			 : '2262-1954',
});
...
var testCases = [ //BOFIP
	{
		 	...
		 	"seeAlso": [],
		 	"attachments": [],
		 	"url": "http://bofip.impots.gouv.fr/bofip/8211-PGP?branch=2",
		 	"date": "27/11/2012",
		 	"ISSN": "2262-1954",
		 	"language": "fre",
		 	"publicationTitle": "Bulletin officiel des Finances Publiques-Impôts",
		 	"rights": "public",
		 	"title": "TVA - Consultation publique partielle - Prolongation de la période de consultation - Mise à jour des précisions sur les règles de détermination de la base d'imposition de la TVA à l'importation (article 292 du CGI)",
...
//Actualités      
		 	...
		 	"seeAlso": [],
		 	"attachments": [],
		 	"url": "http://bofip.impots.gouv.fr/bofip/473-PGP/version/43",
		 	"callNumber": "BOI-TVA-BASE-10-20-60-20121127",
		 	"date": "27/11/2012",
		 	"ISSN": "2262-1954",
		 	"language": "fre",
		 	"publicationTitle": "Bulletin officiel des Finances Publiques-Impôts",
		 	"rights": "public",
		 	"title": "TVA - Base d'imposition - Règles applicables à des opérations déterminées - Modalités particulières de détermination de la base d'imposition",
		 	"libraryCatalog": "BOFiP-Impôts",
		 	"accessDate": "CURRENT_TIMESTAMP"
		 },
