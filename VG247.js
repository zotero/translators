{
	...
	"lastUpdated": "2017-03-12 05:58:52"
}
...
attachments      : [{ url: FW.Url(),
  title:  "VG247 snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//span[@class="author"]').text().replace(/By /,'').cleanAuthor("author"),
date             : FW.Xpath('//span[@class="timestamp"]').text().replace(/[A-z]+,\s(.*)/, '$1'),
blogTitle        : "VG247",
language         : "en-UK",
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/\/tag\//), // tags
choices          : {
  titles  :  FW.Xpath('//div[@class="headlines"]//div/h2/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="headlines"]//div/h2/a').key("href").trim(),
  titles  :  FW.Xpath('//div[@id="headlines"]//div/h2/a').text().trim(),
  urls    :  FW.Xpath('//div[@id="headlines"]//div/h2/a').key("href").trim()
  }
});

FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/\/\?s=/), // search
choices          : {
  titles  :  FW.Xpath('//div[@id="results"]//div/h2/a').text().trim(),
  urls    :  FW.Xpath('//div[@id="results"]//div/h2/a').key("href").trim()
  }
});
/** BEGIN TEST CASES **/
var testCases = [
		...
		"items": [
			{
				...
				"date": "12 December 2010 07:44 GMT",
				"abstractNote": "Red Dead Redemption scooped the Game of the Year award at this year’s VGA’s, pipping Mass Effect 2, which still managed to scoop two awards of its own, including best RPG and best Xbox 360 game. Elsewhere in the awards, Kratos managed to sco…",
				"blogTitle": "VG247",
				"language": "en-UK",
				"url": "https://www.vg247.com/2010/12/12/spike-vga-2010-winners-red-dead-redemption-scoops-goty/",
				"attachments": [
		...
		"items": [
			{
				...
				"date": "26 October 2010 14:46 GMT",
				"abstractNote": "Rockstar will release the disc version of Red Dead Redemption: Undead Nightmare in the US on November 23 and November 26 in EU for PS3 and 360. The title, playable on its own without a copy of the main RDR, will also feature all of the other DLC packs rel…",
				"blogTitle": "VG247",
				"language": "en-UK",
				"shortTitle": "RDR",
				"url": "https://www.vg247.com/2010/10/26/standalone-rdr-undead-nightmare-disc-releasing-in-us-on-november-23-november-26-on-eu/",
	...
	{
		"type": "web",
		"url": "https://www.vg247.com/tag/nintendo-switch/",
		"items": "multiple"
	},
	{
		"type": "web",
