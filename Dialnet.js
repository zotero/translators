{
	...
	"target": "^https?://dialnet\\.unirioja\\.es/servlet/",
	"minVersion": "2.1",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2011-09-13 09:36:41"
}
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/(\/servlet\/busquedadoc)/),
choices          : {
...
var testCases = [
	{
		"type": "web",
		"url": "http://dialnet.unirioja.es/servlet/busquedadoc?t=politica&db=1&td=todo",
		"items": "multiple"
	},
	{
		"type": "web",
		...
		"items": [
			{
				...
				"creators": [
					{
						"firstName": "Lozano Ardila, Martha",
						"lastName": "Cecilia",
						"creatorType": "author"
					},
					{
						"firstName": "Alvarado, Sara",
						"lastName": "Victoria",
						"creatorType": "author"
					}
				],
