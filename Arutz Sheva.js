{
	"translatorID": "8e8488ec-dfc7-49d5-84a4-7f050ce6e008",
	"label": "Arutz Sheva",
	"creator": "Anonymous",
	"target": "/^https?:\\/\\/(?:www\\.)?(?:akhbar7\\.co\\.il|inn\\.co\\.il|7kanal\\.co\\.il|israelnationalnews\\.com)\\/news\\/.*/gm",
	"minVersion": "5.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
...
var testCases = [
	...
	},
	{
		...
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "الجيش الإسرائيلي يمنع دخول السيارات الصينية إلى قواعده | القناة 7",
				"creators": [],
				"language": "ar",
				"libraryCatalog": "Arutz Sheva",
