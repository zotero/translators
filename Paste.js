{
	...
	"lastUpdated": "2017-03-12 08:06:14"
}
...
FW.Scraper({
itemType         : 'blogPost',
detect           : FW.Url().match(/(\/blogs\/)|(\/articles\/)/),
title            : FW.Xpath('//meta[@property="og:title"]/@content').text(),
attachments      : [{ url: FW.Url(),
  title:  "Paste snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//div[@class="bylinepublished"]/a').text().cleanAuthor("author"),
date             : FW.Xpath('//div[@class="bylinepublished"]').text().replace(/.*\|\s(.*)\s\|.*/,'$1'),
blogTitle        : "Paste",
language         : "en-US",
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/search\?t=/), // search
choices          : {
  titles  :  FW.Xpath('//section[@id="search-detail-container"]//a[@class="non title"]').text().trim(),
  urls    :  FW.Xpath('//section[@id="search-detail-container"]//a[@class="non title"]').key("href")
  }
});

FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/\/tag\//), // tag
choices          : {
  titles  :  FW.Xpath('//section[@id="tags-detail-container"]//a[@class="non title"]').text().trim(),
  urls    :  FW.Xpath('//section[@id="tags-detail-container"]//a[@class="non title"]').key("href")
  }
});
/** BEGIN TEST CASES **/
var testCases = [
	...
	{
		"type": "web",
		"url": "https://www.pastemagazine.com/articles/2014/02/earthbound-by-ken-baumann.html",
		"items": [
			{
				"itemType": "blogPost",
				"title": "EarthBound by Ken Baumann",
				"creators": [
					{
						"firstName": "Cameron",
						"lastName": "Kunzelman",
				...
				"abstractNote": "The core concept of this book is that Baumann played the much-loved Super Nintendo game EarthBound as a child, and now that he is an adult, a critical reflection on this coming-of-age story is in order.",
				"blogTitle": "Paste",
				"language": "en-US",
				"url": "https://www.pastemagazine.com/articles/2014/02/earthbound-by-ken-baumann.html",
				"attachments": [
	...
	{
		"type": "web",
		"url": "https://www.pastemagazine.com/tag/earthbound",
		"items": "multiple"
	}
]
/** END TEST CASES **/