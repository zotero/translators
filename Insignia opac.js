{
	...
	"label": "Insignia opac",
	"creator": "Niko",
	"target": "http://www.insigniasoftware.com/opac/",
	"minVersion": "3.0",
	"maxVersion": "",
	"priority": 300,
	"inRepository": true,
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2012-09-04 14:46:08"
}
...
var xpathAuthor = '//table[@id="tbDetailInfo_Basic"]/tbody/tr/td/label[@name="Author"]';
...
var xpathDescription = '//table[@id="tbDetailInfo_Publication"]/tbody/tr/td/label[@name="Collation"]';
	...
	if(title!=null && title.length>0){
		...
		Zotero.debug("CallNumber:"+CallNumber);
		
		var Edition = ZU.xpathText(doc, xpathEdition);
		
		Zotero.debug("Edition:"+Edition);
		
		var Authors = ZU.xpathText(doc, xpathAuthor);
		
		Zotero.debug("Authors:"+Authors);
		...
		Zotero.debug("Description:"+Description);
...
var testCases = [
	{
		"type": "web",
		"url": "http://localhost:11977/Webopac2010/Search.aspx",
		"items": [
			{
				"itemType": "webpage",
				"creators": [],
