{
	"translatorID": "797c7c7a-bb43-4b9e-bc6e-63b720fa1bb9",
	"label": "Vox",
	"creator": "czar",
	"target": "^https?://(www\\.)?vox\\.com",
	"minVersion": "3.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2015-12-08 17:24:33"
}
...
date             : FW.Xpath('//meta[@property="article:published_time"]/@content').text().split("T"),
blogTitle        : "Vox",
language         : "en-US",
...
var testCases = [
	{
		"type": "web",
		"url": "http://www.vox.com/2015/12/7/9859150/chimamanda-adichie-feminism-sweden",
		"items": [
			{
				"itemType": "webpage",
				"title": "Every Swedish teenager is about to get a brilliant crash course in feminism",
				"creators": [
					{
						"firstName": "Caroline",
						"lastName": "Framke",
				...
				"date": "2015-12-07",
				"abstractNote": "Thanks to Chimamanda Ngozie Adichie's \"We Should All Be Feminists.\"",
				"language": "en-US",
				"url": "http://www.vox.com/2015/12/7/9859150/chimamanda-adichie-feminism-sweden",
				"attachments": [
					{
