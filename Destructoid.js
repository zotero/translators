{
	"translatorID": "766f6c6b-1a03-4ef7-b4e8-e89435e3a054",
	"label": "Destructoid",
	"creator": "czar",
	...
	"lastUpdated": "2017-03-14 21:10:24"
}
...
FW.Scraper({
itemType         : 'blogPost',
detect           : FW.Url().match(/\d+\.phtml/), // reviews and news
title            : FW.Xpath('//meta[@property="og:title"]/@content').text(),
attachments      : [{ url: FW.Url(),
  title:  "Destructoid snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//meta[@property="og:author"]/@content').text().cleanAuthor("author"),
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/products_detail\.phtml\?p=/), // specific game pages
choices          : {
  titles  :  FW.Xpath('//h2[@class="sparticle_title"]/a').text().trim(),
  urls    :  FW.Xpath('//h2[@class="sparticle_title"]/a').key("href").trim()
  }
});
/** BEGIN TEST CASES **/
var testCases = [
	...
	{
		"type": "web",
		"url": "https://www.destructoid.com/check-out-what-s-new-in-mario-kart-8-deluxe-with-this-overview-trailer-424037.phtml",
		"items": [
			{
				"itemType": "blogPost",
				"title": "dummy",
				...
				"abstractNote": "I'm not sure if Mario Kart 8 Deluxe is going to be a system seller (especially since The Legend of Zelda: Breath of the Wild already had such a strong opening for the Switch), but this is from the perspective of someone who poured tons...",
             	"blogTitle": "Destructoid",
	...
	{
		"type": "web",
		"url": "https://www.destructoid.com/products_detail.phtml?p=Mario+Kart+8+Deluxe&c=news",
		"items": "multiple"
	}
]
/** END TEST CASES **/
