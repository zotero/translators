{
	...
	"lastUpdated": "2012-08-26 23:34:02"
}
...
archiveLocation  : FW.Xpath('//div[@about="#file"]/div[starts-with(@property,"bibo:locator")]/@content').text(),
pages            : FW.Xpath('//h2/@data-page').text(),
archive          : FW.Xpath('//div[@about="#repository"]/div[@property="foaf:name"]/@content').text(),
		...
		"items": [
			{
				...
				"archiveLocation": "B2455, WRAGGE C L E",
				"libraryCatalog": "dhistory Archives Viewer",
				"manuscriptType": "folio",
				"pages": "3",
