{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2011-11-01 15:51:48"
}
...
/** Search results  disabled bc of permission denied error.
FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//section[@class="feature search-result "]'),
choices : {titles : FW.Xpath('//section[@class="feature search-result "]/h2/a').text().trim(),
urls : FW.Xpath('//section[@class="feature search-result "]/h2/a').key('href').text() }
});  
*/
