{
	...
	"lastUpdated": "2017-03-14 07:51:06"
}
...
FW.Scraper({
itemType         : 'blogPost',
detect           : FW.Url().match(/-\d{4,}$/),
title            : FW.Xpath('//meta[@property="og:title"]/@content').text(),
attachments      : [{ url: FW.Url(),
  title:  "Artnet News snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//p[@class="article-byline"]/a').text().cleanAuthor("author"),
...
hooks : { "scraperDone": function  (item,doc,url) {
	if (item.creators[0].lastName == "Team") {
		...
		item.creators[0].lastName = "Artnet Galleries Team";
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/\/(search\/|about\/|market|art-world|exhibitions|opinion|videos)/),
choices          : {
  titles  :  FW.Xpath('//li[@class="media"]//h2[@class="teaser-title h2"]').text().trim(),
  urls    :  FW.Xpath('//li[@class="media"]/article/a').key("href").trim()
}
});
/** BEGIN TEST CASES **/
var testCases = [
	{
		...
		"items": [
			{
				"itemType": "blogPost",
				"title": "Meet 12 Contemporary African Artists Making Waves in the Art World | artnet News",
				"creators": [
					{
						"firstName": "Rain",
						"lastName": "Embuscado",
	...
	},
	{
		...
		"items": [
			{
				"itemType": "blogPost",
				"title": "What not to miss at the 56th Venice Biennale - artnet News",
				"creators": [
					{
						"firstName": "Christie",
						"lastName": "Chu",
	...
	},
	{
		...
		"items": [
			{
				"itemType": "blogPost",
				"title": "Joseph Beuys Works On Sale at the Armory - artnet News",
				"creators": [
					{
						"firstName": "Rozalia",
						"lastName": "Jovanovic",
