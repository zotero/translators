{
	...
	"lastUpdated": "2012-09-05 01:46:02"
}
...
attachments      : [{ url: FW.Url(),
  ...
  type: "text/html" }],
creators         : FW.Xpath('//div[@id="writer"]/b').text().capitalizeTitle(true	).cleanAuthor("author"),
date             : FW.Xpath('//div[@id="date"]').text().replace(/^.+?,/, ""),
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Xpath('//table[@id="SignpostBlock"]/tbody/tr[1]/td[1]/text()').text().match(/Google Search Results/),
choices          : {
  titles :  FW.Xpath('//td/div/a[@class="gs-title"]').text().trim(),
  urls    :  FW.Xpath('//td/div/a[@class="gs-title"]').key("href")
}
});
/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://www.japantimes.co.jp/text/nn20120509a2.html",
		"items": [
			{
				"itemType": "newspaperArticle",
				"creators": [
				...
				"url": "http://www.japantimes.co.jp/text/nn20120509a2.html",
				"abstractNote": "The ruling Democratic Party of Japan reinstated the party membership of Ichiro Ozawa on Tuesday, a move that intensifies the power struggle over a proposed tax hike the DPJ heavyweight opposes and opens the door for him to run in the party presidential election in September, when Prime Minister Yoshihiko Noda's term expires.",
				"date": "May 9, 2012",
				"ISSN": "0447-5763",
				"language": "en",
				"publicationTitle": "The Japan Times Online",
	...
	{
		"type": "web",
		"url": "http://www.japantimes.co.jp/gsearch/?q=argentina",
		"defer": true,
		"items": "multiple"
	}
]
