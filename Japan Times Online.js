{
	...
	"lastUpdated": "2013-02-07 00:42:35"
}
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Xpath('//h1[@class="search-title"]'),
choices          : {
  titles :  FW.Xpath('//header/hgroup/h1/a').text(),
  urls    :  FW.Xpath('//header/hgroup/h1/a').key("href")
}
});
/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://aws.japantimes.co.jp/news/2012/05/09/news/dpj-reinstates-noda-tax-foe-ozawa/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"creators": [
				...
				"url": "http://aws.japantimes.co.jp/news/2012/05/09/news/dpj-reinstates-noda-tax-foe-ozawa/",
				"abstractNote": "The ruling Democratic Party of Japan reinstated the party membership of Ichiro Ozawa on Tuesday, a move that intensifies the power struggle over a proposed tax hike the DPJ heavyweight ...",
				"date": "May 9, 2012",
				"ISSN": "0447-5763",
				"language": "en-US",
				"publicationTitle": "The Japan Times Online",
	...
	{
		"type": "web",
		"url": "http://www.japantimes.co.jp/?s=labor&submit=Search",
		"items": "multiple"
	},
	{
		"type": "web",
		...
		"items": [
			{
				...
				"url": "http://www.japantimes.co.jp/life/2013/02/05/digital/expat-game-developers-have-an-unfair-advantage-in-japan/#at_pco=cfd-1.0",
				"abstractNote": "Making video games for home consoles such as the Wii U, the PS3, and the Xbox 360 can get really expensive really fast. The huge teams and corporate money involved ...",
				"date": "Feb 5, 2013",
				"ISSN": "0447-5763",
				"language": "en-US",
				"publicationTitle": "The Japan Times Online",
