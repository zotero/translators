{
	...
	"target": "http://(www)?.rechercheisidore.fr/search/resource/[^/]",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	"translatorType": 4,
	"browserSupport": "g",
	"lastUpdated": "2012-11-14 16:20:04"
}
...
detect           : FW.Xpath('//meta[@content="Articles"] [@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
series		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
language		 : FW.Xpath('//meta[@name="DC.language"]/@content').text(),
tags 			: FW.Xpath('//meta[@name="DC.subject"]/@content').text(),
title			 : FW.Xpath('//meta[@name="DC.title"]/@content').text(),
});

FW.Scraper({
itemType         : 'book',
detect           : FW.Xpath('//meta[@content="Ouvrages"][@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
series		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
...
detect           : FW.Xpath('//meta[@content="Actualités"][@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
series		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
...
detect           : FW.Xpath('//meta[@content="Colloques et conférences"][@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
series		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
...
FW.Scraper({
itemType         : 'thesis',
detect           : FW.Xpath('//meta[@content="Mémoires, Thèses et HDR"] [@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
series		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
...
FW.Scraper({
itemType         : 'webpage',
detect           : FW.Xpath('//meta[@content="Page Web"][@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
series		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
...
FW.Scraper({
itemType         : 'artwork',
detect           : FW.Xpath('//meta[@content="Photos et images"][@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
archiveLocation		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
language		 : FW.Xpath('//meta[@name="DC.language"]/@content').text(),
tags 			: FW.Xpath('//meta[@name="DC.subject"]/@content').text(),
title			 : FW.Xpath('//meta[@name="DC.title"]/@content').text(),
...
FW.Scraper({
itemType         : 'manuscript',
detect           : FW.Xpath('//meta[@content="Manuscrits"][@name="DC.type"]'),
abstractNote	 : FW.Xpath('//meta[@name="DC.description"]/@content').text(),
creators		 : FW.Xpath('//meta[@name="DC.creator"]/@content').text().cleanAuthor("author","true"),
archiveLocation		 : FW.Xpath('//meta[@name="DC.publisher"]/@content').text(),
date			 : FW.Xpath('//meta[@name="DC.date"]/@content').text(),
