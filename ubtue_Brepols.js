...
function invokeEMTranslator(doc, url) {
	...
	translator.setHandler('itemDone', function (t, i) {
		let abstractsEntries = doc.querySelectorAll('.abstractSection.abstractInFull');
		let abstractNr = 0;
		for (abstract of abstractsEntries) {
			if (abstractNr == 0) i.abstractNote = abstract.innerText;
			else if (abstractNr == 1) i.notes.push("abs:"  + abstract.innerText);
