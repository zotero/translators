{
	...
	"lastUpdated": "2023-05-24 07:23:18"
}
...
function invokeEMTranslator(doc, url) {
	...
	translator.setHandler('itemDone', function (t, i) {
		...
		for (abstract of abstractsEntry) {
			...
			else i.notes.push("abs1:"  + abstract.innerText);
			abstractNr += 1;
		}
		...
		"items": [
			{
				...
				"notes": [
					...
					"abs1:The first part of the present article clears up an old mistake: lost works of an unknown author \"Iacobus episcopus\" have been wrongly deduced from entries in some Carolingian library catalogues from Lorsch. Actually, these entries testify to a certain collection of works by Ambrose of Milan which, in a comparable form, is otherwise known from only one later codex (Karlsruhe, BLB Aug. perg. 130, s. x1). The Ambrosian corpus attested for Lorsch is of interest for the transmission and edition of the relevant texts, especially the speeches on the death of Satyrus. These matters are discussed in the second part of the present article."
				],
				"seeAlso": []
			}
		]
