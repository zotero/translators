{
	"translatorID": "f0acc51c-b548-4398-84e7-68dc2414d8ca",
	"label": "The Guardian (Nigeria)",
	"creator": "VWF",
	"target": "^https?://www\\.?.guardian\\.ng/",
	"minVersion": "5.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2025-11-07 10:37:19"
}
...
function detectWeb(doc) {
	...
	if (text(doc, 'article>h1.post-title, article h1.page-title')) {
		return 'newspaperArticle';
	}
...
async function scrape(doc, url) {
	...
	if (data) {
		item.title = ZU.unescapeHTML(
			data.headline
			|| meta(doc, 'og:title')
			|| text(doc, 'article>h1.post-title, article h1.page-title')
			|| ''
		);
		...
		if (data.author) {
			...
			for (let a of authors) {
				...
				if (
					name
					&& !/agency|news desk|agency reporter|afp|editorial board|guardian|our reporter|nigeria|staff|bureau/i.test(name.toLowerCase())
...
var testCases = [
	{
		"type": "web",
		"url": "https://guardian.ng/news/nigeria/metro/southern-monarchs-visit-uzodimma-appoint-him-coordinator/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "Southern monarchs visit Uzodimma, appoint him coordinator",
				"creators": [
					{
						"firstName": "Charles",
						"lastName": "Ogugbuaja",
	...
	{
		"type": "web",
		"url": "https://guardian.ng/opinion/fifa-and-nigerian-football-development/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "FIFA and Nigerian football development",
				"creators": [
					{
						"firstName": "Bob Majiri Oghene",
						"lastName": "Etemiku",
						"creatorType": "author"
					}
				],
				"date": "2025-11-07",
				"ISSN": "0189-5125",
				"abstractNote": "After Nigeria pulled off the Miracle of Damman in 1989, and went on to ride-roughshod over Argentina and Brazil at the USA 94 Olympic",
				"language": "en-US",
				"libraryCatalog": "The Guardian (Nigeria)",
				"place": "Nigeria",
				"publicationTitle": "The Guardian",
