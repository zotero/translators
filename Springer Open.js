{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2012-03-08 03:46:56"
}
...
choices : {
  titles : FW.Xpath('//span[@class="article-title"]/../following-sibling::p[1]//a[text()]').text().trim(),
  urls : FW.Xpath('//span[@class="article-title"]/../following-sibling::p[1]//a[text()]').key("href")
}
});
