{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2012-01-30 22:37:56"
}
...
attachments      : [{ 
  url: FW.Xpath('//a[contains(@class, "article_print")]/@href').text().prepend("www.foreignaffairs.com"),
...
abstractNote     : FW.Xpath('//div[@class="field-article-summary-hidden-inner"]/span[contains(@class, "article-summary")]').text(),
ISSN			 : "0015-7120",
