{
	...
	"lastUpdated": "2017-03-12 07:22:47"
}
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/(\/tag\/)|(search\?q=)/), // tag or search pages
choices          : {
  titles  :  FW.Xpath('//header/h1/a').text().trim(),
  urls    :  FW.Xpath('//header/h1/a').key("href")
  }
});

FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Xpath('//div[contains(concat(" ", normalize-space(@class), " "), " curation-main-container ")]'), // main page
choices          : {
  titles  :  FW.Xpath('//header/h1/a').text().trim(),
  urls    :  FW.Xpath('//header/h1/a').key("href")
  }
...
var testCases = [
	{
		"type": "web",
		"url": "http://kotaku.com/the-10-best-game-expansions-1732758285",
		"items": [
			{
				"itemType": "blogPost",
				...
				"date": "2015-12-23T06:30:00-05:00",
	...
	{
		"type": "web",
		"url": "http://compete.kotaku.com/12-smash-tournament-organizers-quit-after-leader-accuse-1793188405",
		"items": [
			{
				"itemType": "blogPost",
				"title": "12 Smash Tournament Organizers Quit After Leader Accused Of Multiple Acts Of Sexual Harassment",
				"creators": [
					{
						"firstName": "Eric Van",
						"lastName": "Allen",
				...
				"date": "2017-03-11T15:37:00-05:00",
				"abstractNote": "Several core members of the BEAST crew, an organization that hosts an annual Super Smash Bros. tournament, announced their departure today in the wake of sexual harassment allegations brought against BEAST head organizer Lolex.",
				"blogTitle": "Kotaku",
				"language": "en-US",
				"url": "http://compete.kotaku.com/12-smash-tournament-organizers-quit-after-leader-accuse-1793188405",
				"attachments": [
	...
	{
		"type": "web",
		"url": "http://kotaku.com/tag/earthbound",
		"items": "multiple"
	},
	{
		"type": "web",
		"url": "http://kotaku.com/search?q=earthbound",
		"items": "multiple"
	},
	{
		"type": "web",
