{
	...
	"inRepository": true,
	"translatorType": 4,
	"lastUpdated": "2011-07-19 19:03:38"
}
...
// Delegate to MARC
FW.Scraper({
	// It'd be hard to discern item type a priori...
itemType         : 'book',
detect           : FW.Url().match(/\/item\/(?:show|catalogue_info)/),
		...
		"items": [
			{
				...
				"libraryCatalog": "Library Catalog (Bibliocommons)"
			}
		]
	},
	{
