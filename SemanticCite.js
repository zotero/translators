{
	"translatorID": "663c04a0-2bd2-4523-a5a2-640479da8af5",
	"label": "SemanticCite",
	"creator": "Ruben van de Ven (based on Bibtex translator by Simon Kornblith, Richard Karnesky and Emiliano heyns)",
	"target": "wiki",
	"minVersion": "2.1.9",
	"maxVersion": "",
	"priority": 200,
	...
	"inRepository": true,
	"translatorType": 2,
	"lastUpdated": "2021-02-25 11:28:17"
}

/*
   SemanticCite translator
   (exporter only, Heavily based on the BibTeX Translator)
   
   Copyright (C) 2021 Ruben van de Ven
...
var fieldMap = {
	...
	url:"url",
	doi:"DOI",
	// abstract:"abstractNote", // no abstract in SMW
  	nationality: "country",
  	language:"language",
  	assignee:"assignee"
};
...
function doExport() {
	...
	while (item = Zotero.nextItem()) {
		...
		if (item.creators && item.creators.length) {
			...
			for (var i in item.creators) {
				...
				if (creator.fieldMode == true) { // fieldMode true, assume corporate author
					...
					creatorString = creatorString; // avoid double {{ in SMW
				} else {
		...
		// We don't want notes in the wiki
