{
	...
	"lastUpdated": "2013-02-06 23:50:28"
}
...
attachments      : [{ url: FW.Url().replace(/node/,"print"),
  ...
  type: "text/html" }],
creators         : FW.Xpath('//div[contains(@class, "byline")]/strong[1]').text().replace(/\|.+/, "").cleanAuthor("author"),
date             : FW.Xpath('//div[contains(@class, "byline")]/strong').text().match(/\s*[A-Za-z]+\s*\d\d?,\s*\d{4}/),
