{
	...
	"lastUpdated": "2014-04-26 14:23:03"
}
...
attachments      : [{
  ...
  type: "text/html"}],
creators         : FW.Xpath('//header/ul[@class="post-item-meta"]//a[contains(@class, "post-item-author")]/span').text().cleanAuthor("author"),
date             : FW.Xpath('//time[@class="post-date"]').text(),
abstractNote     : FW.Xpath('//meta[@property="og:description"]/@content').text(),
websiteTitle     : FW.Xpath('//header/ul[@class="post-item-meta"]//a[contains(@class, "post-item-collection")]').text().prepend("Medium: "),
...
var testCases = [
	...
	{
		"type": "web",
		"url": "https://medium.com/technology-and-society/7957d8e685c4",
		"items": [
			{
				"itemType": "webpage",
				"creators": [
				...
				"url": "https://medium.com/technology-and-society/7957d8e685c4",
				"abstractNote": "Turkey’s election night was a strange one. Many questions swirled around the process, coalescing into an uproar — and then a citizen-led…",
				"date": "April 24, 2014",
				"title": "What If the Feature Is the Bug? Election monitoring, new power of social media and old power of structural power",
				"websiteTitle": "Medium: Technology and Society",
		...
		"items": [
			{
				...
				"url": "https://medium.com/@zeynep",
				"abstractNote": "The profile of Zeynep Tufekci",
				"date": "April 24, 2014",
				"title": "What If the Feature Is the Bug? Election monitoring, new power of social media and old power of structural power",
				"websiteTitle": "Medium: Technology and Society",
				"libraryCatalog": "Medium",
