{
	...
	"lastUpdated": "2015-08-03 14:15:51"
}
...
FW.Scraper({
itemType         : 'webpage',
detect           : FW.Xpath('//main[contains(@class, "postArticle")]'),  //div[@class="section-content"]//*[h2 or h3]'),
title            : FW.Xpath('//div[@class="section-content"]//h2|//div[@class="section-content"]//h3').text(),
attachments      : [{
  url: FW.Url(),
  title: "Medium Snapshot",
  type: "text/html"}],
creators         : FW.Xpath('//meta[@name="author"]/@content').text().cleanAuthor("author"),
date             : FW.Xpath('//meta[@property="article:published_time"]/@content').text().remove(/T.+/),
abstractNote     : FW.Xpath('//meta[@property="og:description"]/@content').text(),
websiteTitle     : "Medium",
hooks : { "scraperDone": function  (item,doc, url) {
	 var subtitle = ZU.xpathText(doc, '//div[@class="section-content"]//h4');
	 if (subtitle){
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Xpath('//div[@class="block-content"]//h3[@class="block-title"]'),
choices          : {
  titles :  FW.Xpath('//div[@class="block-content"]//h3[@class="block-title"]/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="block-content"]//h3[@class="block-title"]/a').key("href")
}
});
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Xpath('//div[@class="block-content"]/article/a'),
choices          : {
  titles :  FW.Xpath('//div[@class="block-content"]/article/a//h2|//div[@class="block-content"]/article/a//h3').text().trim(),
  urls    :  FW.Xpath('//div[@class="block-content"]/article/a[*//h2 or *//h3]').key("href")
}
});
/** BEGIN TEST CASES **/
var testCases = [
