{
	...
	"lastUpdated": "2013-09-25 16:04:11"
}
...
FW.Scraper({
itemType : 'blogPost',
detect : FW.Url().match(/newrepublic\.com\/blog\//),
title : FW.Xpath('//div[@id="primary-title"]//h2/strong').text().trim(),
attachments : {
  url : FW.Url(),
  title : "New Republic Snapshot",
  type : "text/html"
},
creators : FW.Xpath('//span[@class="authors"]/a').text().capitalizeTitle(true).cleanAuthor("author"),
abstractNote : FW.Xpath('//div[contains(@class, "deck")]/h2').text(),
date : FW.Xpath('//span[@class="date"]').text(),
publicationTitle : FW.Url().match(/\/blog\/[^\/]+/).remove(/^\/[^\/]+\//).capitalizeTitle(true).prepend("New Republic Blog - ")
});

/** Articles */
FW.Scraper({
itemType : 'magazineArticle',
detect : FW.Xpath('//div[@id="primary-title"]//h2'),
title : FW.Xpath('//div[@id="primary-title"]//h2/strong').text().trim(),
attachments : {
  url : FW.Url(),
  title : "New Republic Snapshot",
...
FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//ul[@id="result-items"]//h3/a'),
choices : {
  titles : FW.Xpath('//ul[@id="result-items"]//h3/a').text(),
  urls : FW.Xpath('//ul[@id="result-items"]//h3/a').key('href').text()
}
});
/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://www.newrepublic.com/blog/plank/109551/fear-winning",
		"items": [
			{
				"itemType": "blogPost",
				"creators": [
				...
				"publicationTitle": "New Republic Blog - Plank",
	...
	{
		"type": "web",
		"url": "http://www.newrepublic.com/search/site/labor",
		"items": "multiple"
	}
]
/** END TEST CASES **/