{
	...
	"lastUpdated": "2012-11-03 16:25:05"
}
...
Created as part of the 2012 Zotero Trainer Workshop in Syracuse. 
Special 
...
FW.Scraper({
itemType : 'blogPost',
detect : FW.Url().match(/tnr\.com\/blog\//),
title : FW.Xpath('//div[contains(@class, "entry_header")]/h1').text().trim(),
attachments : {
  url : FW.Url(),
  title : "New Republic Snapshot",
  type : "text/html"
},
creators : FW.Xpath('//div[@class="author"]//h3').text().cleanAuthor("author"),
abstractNote : FW.Xpath('//div[contains(@class, "deck")]/h2').text(),
date : FW.Xpath('//li[@class="post_date"]').text().remove(/\|.*/),
publicationTitle : FW.Url().match(/\/blog\/[^\/]+/).remove(/^\/[^\/]+\//).capitalizeTitle(true).prepend("TNR.com Blog - ")
});

/** Articles */
FW.Scraper({
itemType : 'magazineArticle',
detect : FW.Xpath('//div[contains(@class, "entry_header")]/h1'),
title : FW.Xpath('//div[contains(@class, "entry_header")]/h1').text().trim(),
attachments : {
  url : FW.Url(),
  title : "New Republic Snapshot",
...
FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//dl[contains(@class, "search-results")]'),
choices : {
  titles : FW.Xpath('//div[@class="entry_title"]/a').text(),
  urls : FW.Xpath('//div[@class="entry_title"]/a').key('href').text()
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://www.tnr.com/article/politics/magazine/108848/the-terrifying-rise-greeces-nazi-party",
		"items": [
			{
				"itemType": "magazineArticle",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.tnr.com/blog/plank/109551/fear-winning",
		"items": [
			{
				"itemType": "blogPost",
				"creators": [
				...
				"publicationTitle": "TNR.com Blog - Plank",
				"title": "Liberals Worry, “What If We Win?”",
				"libraryCatalog": "The New Republic",
				"accessDate": "CURRENT_TIMESTAMP",
				"shortTitle": "Liberals Worry, “What If We Win?"
			}
		]
	},
	{
		"type": "web",
		"url": "http://www.tnr.com/search/apachesolr_search/labor",
		"items": "multiple"
	}
]
/** END TEST CASES **/