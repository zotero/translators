{
	...
	"lastUpdated": "2013-04-23 21:10:22"
}
...
abstractNote	 : FW.Xpath('//div[@id="main-article-info"]/p[@id="stand-first"]').text().trim(),
...
choices          : {
  titles  :  FW.Xpath('//div[@class="most-recent-results"]//h3/a[not(contains(@href, "/video/"))]').text().trim(),
  urls    :  FW.Xpath('//div[@class="most-recent-results"]//h3/a[not(contains(@href, "/video/"))]').key("href")
}
});
/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://www.guardian.co.uk/world/2013/mar/05/hugo-chavez-dies-cuba",
		"items": [
			{
				"itemType": "newspaperArticle",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.guardian.co.uk/world/2013/mar/06/pentagon-iraqi-torture-centres-link",
		"items": [
			{
				"itemType": "newspaperArticle",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.guardian.co.uk/world/2013/feb/26/football-heaven-god-play?INTCMP=SRCH",
		"items": [
			{
				"itemType": "newspaperArticle",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.guardian.co.uk/search?q=argentina&section=uk%7Cworld",
		"items": "multiple"
	}
]
/** END TEST CASES **/