{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2012-03-03 23:33:24"
}
...
function getItems(doc, url) {
	var items = {};	
	var links = doc.evaluate('//*[@class="ArchiveList"]//*[@class="AS55"]/a', doc, null, XPathResult.ANY_TYPE, null);
...
function doWeb(doc, url) {
	...
	// search results / other page
		...
		var items = Zotero.selectItems(getItems(doc, url));
...
function scrape(doc,url) {
	...
	if (title1==null)
		title1 = doc.evaluate('//div[@class="JournalAbstract"]/div/h1', doc, null, XPathResult.ANY_TYPE, null).iterateNext();
	...
	if (abstract1==null)
		abstract1 = doc.evaluate('//div[@class="JournalAbstract"]/div[@class="abstracttext"]',doc,null,XPathResult.ANY_TYPE,null).iterateNext();
	...
	if (citation1==null) {
		...
		if (citation1!=null) {
			if (!doc.evaluate('//div[@class="metacontainer"]/div[@class="metakey"][2]',doc,null,XPathResult.ANY_TYPE,null).iterateNext(2).textContent.match(/Citation:/))
				citation1 = null;
		}
	}

	if (citation1==null)
		citation1 = doc.evaluate('//div[@class="AbstractSummary"]/p',doc,null,XPathResult.ANY_TYPE,null).iterateNext(2);
	
	if (citation1.textContent.match(/Received/))
		citation1 = doc.evaluate('//div[@class="metacontainer"]/div[@class="metavalue"]',doc,null,XPathResult.ANY_TYPE,null).iterateNext();
	...
	if (abbrev==null)
		abbrev = doc.evaluate('//div[@class="metacontainer"]/div[@class="metavalue"]/i',doc,null,XPathResult.ANY_TYPE,null).iterateNext();
	...
	if (vol==null)
		vol = doc.evaluate('//div[@class="metacontainer"]/div[@class="metavalue"]/b',doc,null,XPathResult.ANY_TYPE,null).iterateNext();
	...
	if (pdf && pdf.href) {
		newItem.attachments = [
		  {url:pdf.href, title:"Full Text PDF", mimeType:"application/pdf"}
	  	];
	}	
	newItem.complete();
}
