{
	...
	"translatorType": 4,
	"browserSupport": "g",
	"lastUpdated": "2011-12-12 00:34:14"
}
...
reportType : FW.Xpath('//meta[@name="citation_journal_title"]/@content').text()
});
...
FW.Scraper({
itemType : 'report',
detect : FW.Xpath('//meta[@name="citation_publisher"]'),
title : FW.Xpath('//meta[@name="citation_title"]/@content').text().trim(),
attachments : [{ url: FW.Xpath('//meta[@name="citation_pdf_url"]/@content').text().trim(),
  title: "RePEc PDF",
  type: "application/pdf" },
		...
		"items": [
			{
				...
				"reportType": "Far East Journal of Psychology and Business",
		...
		"items": [
			{
				...
				"reportType": "Philippine Journal of Development",
