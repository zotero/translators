...
creators         : FW.Xpath ('//div[contains(@class, "field-name-field-authors") and contains(@class, "field-type-text-long") and contains(@class, "field-label-above")]/div[@class="field-items"]/div[contains(@class, "field-item") and contains(@class, "even")]/p')
					.text().remove(/\;.*/m ).split(/\,/).replace(/\s/," ").cleanAuthor("author"),
date             : FW.Xpath ('//div[contains(@class, "field-name-field-citation") and contains(@class, "field-type-text-long") and contains(@class, "field-label-above")]/div[@class="field-items"]/div[contains(@class, "field-item") and contains(@class, "even")]/p').text().match( /\d{4}/ ).trim(),
publicationTitle : "Journal of Clinical Oncology",
url 			 : FW.Url(),
abstractNote	 : FW.Xpath ('//div[contains(@class, "content") and contains(@class, "clearfix")]/div[contains(@class, "field") and contains(@class, "field-name-body") and contains(@class, "field-type-text-with-summary") and contains(@class, "field-label-hidden")]/div[@class="field-items"]/div[contains(@class, "field-item") and contains(@class, "even")]/div[@class="node"]/div[@class="content"]/p[3]').text().remove(/Background:/).trim(),
meetingName 	 : FW.Xpath ('//div[contains(@class, "field-name-field-meeting") and contains(@class, "field-type-taxonomy-term-reference") and contains(@class, "field-label-above")]/div[@class="field-items"]/div[contains(@class, "field-item") and contains(@class, "even")]/div[@class="node"]/div[@class="content"]/a').text().trim(),
tags			 : FW.Xpath ('//div[contains(@class, "field-name-field-subcategories") and contains(@class, "field-type-text") and contains(@class, "field-label-above")]/div[@class="field-items"]/div[contains(@class, "field-item") and contains(@class, "even")]/div[@class="node"]/div[@class="content"]/a').text().remove(/;[\s\S]*/).trim(),
abstractNumber	 : FW.Xpath ('//div/p').text().trim(),
