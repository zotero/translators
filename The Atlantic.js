{
	...
	"lastUpdated": "2013-03-06 23:12:29"
}
...
abstractNote     : FW.Xpath('//div[@class="magArticleTools"]/p[@class="blurb"]').text(),
publicationTitle : "The Atlantic",
ISSN             : "1072-7825"
}); 
...
choices          : {
  ...
  urls    :  FW.Xpath('//div[@id="searchResults"]/div[@class="post"]/h3/a/@href').text()
}
});
