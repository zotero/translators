{
	...
	"lastUpdated": "2012-10-15 21:16:51"
}
...
detect           : FW.Xpath('//h3[@class="article_title"]'),
title            : FW.Xpath('//h3[@class="article_title"]').text().trim(),
attachments      : [{ url: FW.Url(),
  title:  "Boston Review Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//span[@class="article_author"]').text().split(/ and h/).cleanAuthor("author"),
date            : FW.Xpath('//span[@class="article_date"]').text().capitalizeTitle(),
ISSN			 : "0734-2306",
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/contents\.php$/),
choices          : {
...
var testCases = [
	{
		"type": "web",
		"url": "http://www.bostonreview.net/BR37.5/ndf_james_heckman_social_mobility.php",
		"items": [
			{
				"itemType": "magazineArticle",
				"creators": [
				...
				"language": "en-US",
				"publicationTitle": "Boston Review",
				"title": "Lead Essay:Promoting Social Mobility",
				"libraryCatalog": "Boston Review",
				"accessDate": "CURRENT_TIMESTAMP",
				"shortTitle": "Lead Essay"
			}
		]
	},
	{
		"type": "web",
		"url": "http://bostonreview.net/BR37.5/contents.php",
		"items": "multiple"
	}
]
/** END TEST CASES **/