{
	...
	"lastUpdated": "2014-03-26 18:47:57"
}
...
FW.Scraper({
	...
	language			: "nl",
	pages				: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/pageurl:.*p0*(\d+)<br\/>/, 1), /*we used "pageurl:" instead of "page:", because the page number attached to "page:" is not always correct*/
	archive				:"Delpher, Koninklijke Bibliotheek, Den Haag",
	url					:FW.Xpath("//div[@class='persistent-url']/input").key("value").text(),
...
var testCases = [
	...
	{
		"type": "web",
		"url": "http://tijdschriften.delpher.nl/nl/view/index?query=buurman&coll=dts&image=dts:2945045:mpeg21:0001&page=1&maxperpage=10",
		"items": [
			{
				"itemType": "journalArticle",
				"creators": [],
				...
				"seeAlso": [],
				"attachments": [],
				"url": "http://resolver.kb.nl/resolve?urn=dts:2945045:mpeg21:0001",
				"archive": "Delpher, Koninklijke Bibliotheek, Den Haag",
				"date": "1928-10-27",
				"issue": "43",
				"language": "dut",
				"publicationTitle": "De ingenieur",
				"title": "De ingenieur; Weekblad gewĳd aan de techniek en de economie van openbare werken en nĳverheid jrg 43, 1928, no 43, 27-10-1928",
				"volume": "43",
				"libraryCatalog": "Delpher",
				"accessDate": "CURRENT_TIMESTAMP"
			}
