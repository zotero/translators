{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2012-01-09 11:40:00"
}
...
ISSN: "0028-792X",
tags: FW.Xpath('//div[@id="keywords"]').text().trimInternal().remove(/Keywords?/).split(';')
});

 /** Blog Posts */
 FW.Scraper({
itemType : 'blogPost',
detect : FW.Xpath('//div[@id="blogs"]'),
...
tags: FW.Xpath('//div[@class="entry-keywords"]/ul').text().trimInternal().remove(/Keywords?/).split(';')
});
...
var testCases = [
		...
		"items": [
			{
				...
				"attachments": [
					{
						"url": "http://www.newyorker.com/talk/comment/2011/10/31/111031taco_talk_remnick?printable=true",
						"title": "The New Yorker",
						"type": "text/html"
					}
				],
	...
	{
		"type": "web",
		"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/",
		"items": [
			{
				"itemType": "blogPost",
				"creators": [
				...
				"attachments": [
					{
						"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2011/11/mmm-mmm-good.html?printable=true&currentPage=all",
						"title": "The New Yorker",
						"type": "text/html"
					},
					{
						"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2011/11/hamilton-not-coming-to-a-theatre-near-you.html?printable=true&currentPage=all",
						"title": "The New Yorker",
						"type": "text/html"
					},
					{
						"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2011/11/mitts-mutt-gails-waldo.html?printable=true&currentPage=all",
						"title": "The New Yorker",
						"type": "text/html"
					},
					{
						"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2011/11/program-note-1.html?printable=true&currentPage=all",
						"title": "The New Yorker",
						"type": "text/html"
					},
					{
						"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2011/11/oops-rick-perry.html?printable=true&currentPage=all",
						"title": "The New Yorker",
						"type": "text/html"
					},
					{
						"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2011/11/wall-street-road-trip.html?printable=true&currentPage=all",
						"title": "The New Yorker",
						"type": "text/html"
					},
					{
						"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2011/11/occupy-readers.html?printable=true&currentPage=all",
						"title": "The New Yorker",
						"type": "text/html"
					}
				],
