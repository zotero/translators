{
	...
	"lastUpdated": "2017-03-12 02:26:24"
}
...
attachments      : [{ url: FW.Url(),
  title:  "Frieze snapshot",
  type: "text/html" }],
creators         : FW.Xpath('(//div[@class="field-item even"]/a)[1]').text().cleanAuthor("author"),
date             : FW.Xpath('//div[@class="field-item even"]/h4').text().replace(/.*-\s(.*)/,"$1"),
blogTitle        : "Frieze",
language         : "en-UK",
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/\?text_search=/), // search
choices          : {
  titles  :  FW.Xpath('//div[contains(concat(" ", normalize-space(@class), " "), " field-name-title-field ")]/div/div/a').text(),
  urls    :  FW.Xpath('//div[contains(concat(" ", normalize-space(@class), " "), " field-name-title-field ")]/div/div/a').key("href").trim()
  }
});
/** BEGIN TEST CASES **/
var testCases = [
