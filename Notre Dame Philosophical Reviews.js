...
detectWeb = function(doc, url) {
  if (url.match(/^https:\/\/ndpr\.nd\.edu\/news\/[0-9]+/)) {
    return 'journalArticle';
  }
  if (url.match(/^https:\/\/ndpr\.nd\.edu\/recent-reviews/)) {
    return 'multiple';
  }
  if (url.match(/^https:\/\/ndpr\.nd\.edu\/search/)) {
    return 'multiple';
  }
  return null;
};
    ...
    "items": [
      {
        ...
        "shortTitle": "Review of <i>Pleasure and the Good Life",
        "url": "https://ndpr.nd.edu/news/24395-pleasure-and-the-good-life-concerning-the-nature-varieties-and-plausibility-of-hedonism/",
        "attachments": [],
        "tags": [],
    ...
    "items": [
      {
        ...
        "libraryCatalog": "Notre Dame Philosophical Reviews",
        "shortTitle": "Review of <i>Locke's Touchy Subjects",
        "url": "https://ndpr.nd.edu/news/63254-locke-s-touchy-subjects-materialism-and-immortality/",
        "attachments": [],
        "tags": [],
