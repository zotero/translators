{
	...
	"lastUpdated": "2013-05-12 18:35:32"
}
...
abstractNote : FW.Xpath('//meta[@name="description"]/@content').text(),
date : FW.Xpath('//span[@class="date"]').text().remove(/.+\son\s/),
publicationTitle :  FW.Xpath('//meta[@property="og:site_name"]/@content').text().prepend("Roll Call Blog: ")
});
