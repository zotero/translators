{
	...
	"lastUpdated": "2012-11-11 18:38:09"
}
...
detect : FW.Xpath('//div[@id="tabcontent-article"]/h1'),
title : FW.Xpath('//div[@id="tabcontent-article"]/h1').text().trim(),
attachments : {
  url : FW.Url(),
  title : "Roll Call snapshot",
  type : "text/html"
},
creators : FW.Xpath('//ul[@class="byline"]/li/a').text().cleanAuthor("author"),
abstractNote : FW.Xpath('//meta[@name="description"]/@content').text(),
date : FW.Xpath('//ul[@class="byline"]/li[3]').text(),
