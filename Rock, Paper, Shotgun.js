{
	...
	"lastUpdated": "2015-12-08 06:01:10"
}
...
title            : FW.Xpath('//header/h2/a').text().trim(),
...
choices          : {
  titles :  FW.Xpath('//div[@class="post-inner"]/h2/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="post-inner"]/h2/a').key("href")
}
});
...
choices          : {
  titles :  FW.Xpath('//li/div/h3/a').text().trim(),
  urls    :  FW.Xpath('//li/div/h3/a').key("href")
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://www.rockpapershotgun.com/2015/12/04/dr-langeskov-the-tiger-and-the-terribly-cursed-emerald-a-whirlwind-heist-review/",
		"items": [
			{
				"itemType": "blogPost",
	...
	{
		"type": "web",
		"url": "http://www.rockpapershotgun.com/2012/02/23/thought-mass-effects-day-one-dlc-explained-considered/",
		"items": [
			{
				"itemType": "blogPost",
