{
	...
	"translatorType": 4,
	"browserSupport": "g",
	"lastUpdated": "2011-12-09 17:12:03"
}
...
var testCases = [{
	...
	"items": [{
		...
		"notes": [],
		"tags": ["Social sciences", "sociology", "anthropology (300)", "Political science (320)", "Peace and Conflict Research", "International Conflicts", "Security Policy (10507)", "Special areas of Departmental Policy (10508)", "Technology Assessment (20800)", "Computer", "Digitalisierung", "Informationsgesellschaft", "innere Sicherheit", "Staat", "Technikfolgen", "Überwachung"],
		"seeAlso": [],
		"attachments": [{
			"url": "http://en.scientificcommons.org/59739904",
			"title": "Scientific Commons Snapshot",
