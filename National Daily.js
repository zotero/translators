{
	"translatorID": "924a729e-7f16-436f-92c5-0207f07282ce",
	"label": "National Daily",
	"creator": "VWF",
	"target": "^https?://www\\.?nationaldailyng\\.com/",
	"minVersion": "5.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2025-12-13 08:47:24"
}
...
async function scrape(doc, url) {
	...
	if (data) {
		...
		if (data.author) {
			...
			for (let a of authors) {
				...
				if (name && !/agency|news desk|agency reporter|national|our reporter|daily|nigeria|staff|bureau/i.test(name.toLowerCase())) {
	...
	if (!item.publicationTitle) {
		item.publicationTitle = 'National Daily';
	}
	...
	if (item.creators.length === 0) {
		...
		if (cand && !/agency|news desk|agency reporter|national|our reporter|daily|nigeria|staff|bureau/i.test(cand.toLowerCase())) {
...
var testCases = [
	{
		"type": "web",
		"url": "https://nationaldailyng.com/christmas-rush-triggers-surge-in-transport-fares-from-lagos-to-south-east/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "Christmas rush triggers surge in transport fares from Lagos to South-East",
				"creators": [
					{
						"firstName": "Olusegun",
						"lastName": "Odunewu",
				...
				"date": "2025-12-12",
				"ISSN": "1597-5975",
				"abstractNote": "Spread The News Transport fares from Lagos to the South-Eastern states have begun climbing ahead of the annual Christmas travel surge, with operators cautioning that prices will spike further from December 18 when demand traditionally peaks. A market survey across major Lagos motor parks shows current fares ranging from N25,500 to N73,500, depending on destination […]",
				"language": "en-US",
				"libraryCatalog": "National Daily",
				"place": "Nigeria",
				"publicationTitle": "National Daily",
				"url": "https://nationaldailyng.com/christmas-rush-triggers-surge-in-transport-fares-from-lagos-to-south-east/",
				"attachments": [
					{
						"title": "Snapshot",
	...
	{
		"type": "web",
		"url": "https://nationaldailyng.com/gen-yahaya-denies-link-to-terror-financing-threatens-legal-action/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "Gen. Yahaya denies link to terror-financing, threatens legal action",
				"creators": [
					{
						"firstName": "Sunday",
						"lastName": "Odibashi",
				...
				"date": "2025-12-06",
				"ISSN": "1597-5975",
				"abstractNote": "Spread The News Former Chief of Army Staff, retired Lt.-Gen. Faruk Yahaya, has dismissed as false and malicious allegations linking him to individuals purportedly involved in terrorism financing. The allegation, credited to retired Maj.-Gen. Danjuma Ali-Keffi and published by Sahara Reporters, claimed that the former army chief had ties to suspected terror financiers. But Yahaya, […]",
				"language": "en-US",
				"libraryCatalog": "National Daily",
				"place": "Nigeria",
				"publicationTitle": "National Daily",
