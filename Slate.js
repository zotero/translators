{
	...
	"lastUpdated": "2012-10-22 16:26:05"
}
...
detect           : FW.Xpath('//article//h2[@class="sl-art-head-hed"]'),
title            : FW.Xpath('//h2[@class="sl-art-head-hed"]').text().trim(),
attachments      : [{ url: FW.Url().remove(/\?(.*)/).replace(/(\.[1-99])?\.html/, ".single.html" ),
  title:  "Slate Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//p[@class="sl-art-byline"]/a').text().remove(/By/).split(/\ and\ /).cleanAuthor("author"),
date             : FW.Xpath('//span[@class="sl-art-datetime"]').text().remove(/\n/g).remove(/\, at.*/).remove(/.*?day\,/).trim(),
abstractNote     : FW.Xpath('//h1[@class="sl-art-head-dek"]').text().trim(),
language		 : "en-US",
ISSN			 : "1091-2339",
...
/**Multiple */
/** Search currently not working due to permissino issue
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/\/search\.html\?/),
choices          : {
  titles :  FW.Xpath('//a[@class="sl-toc-art-hed-link"]').text().trim(),
  urls    :  FW.Xpath('//a[@class="sl-toc-art-hed-link"]').key("href")
}
}); */
		...
		"items": [
			{
				...
				"attachments": [
					{
						"url": "http://www.slate.com/articles/news_and_politics/history_lesson/2011/10/new_deal_accomplishments_do_conservatives_who_attack_the_new_dea.single.html",
						"title": "Slate Snapshot",
						"type": "text/html"
					}
				],
