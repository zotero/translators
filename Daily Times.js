{
	"translatorID": "7e4502b0-38e4-45e1-a372-2b7c784e52a8",
	"label": "Daily Times",
	"creator": "VWF",
	"target": "^https?://www\\.?.dailytimesng\\.com/",
	"minVersion": "5.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2025-12-15 13:05:28"
}
...
function detectWeb(doc, url) {
	...
	if (text(doc, 'h1.h4.sm:h2.xl:display-8.text-primary')) {
		return 'newspaperArticle';
	}
...
async function scrape(doc, url) {
	...
	function splitAuthors(nameStr) {
		...
		for (let p of parts) {
			...
			if (np && !/^(agency|news desk|agency reporter|times|our reporter|editor|nigeria|staff|bureau)$/i.test(np)) {
				cleaned.push(np);
			}
		}
		return cleaned;
	...
	if (data) {
		item.title = ZU.unescapeHTML(
			data.headline
			|| meta(doc, 'og:title')
			|| text(doc, 'h1.h4.sm:h2.xl:display-8.text-primary')
			|| ''
		);

		// Remove trailing "- Daily Times" or variants
		item.title = item.title.replace(/\s*[-|–—]\s*Daily\s*Times\s*$/i, '').trim();
		...
		if (data.author) {
			...
			for (let a of authors) {
				...
				if (
					name
					&& !/agency|news desk|agency reporter|times|our reporter|editor|nigeria|staff|bureau/i.test(name.toLowerCase())
	...
	if (!item.publicationTitle) {
		item.publicationTitle = 'Daily Times';
	}
	...
	if (item.creators.length === 0) {
		...
		let cand2 = text(doc, 'div.author.hstack.gap-1 a');
...
var testCases = [
	{
		"type": "web",
		"url": "https://dailytimesng.com/nis-announces-temporary-disruptions-on-passport-digital-platform/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "NIS announces temporary disruptions on passport digital platform",
				"creators": [
					{
						"firstName": "Promise",
						"lastName": "Eze",
				...
				"date": "2025-12-12",
				"ISSN": "0331-2739",
				"abstractNote": "The Nigeria Immigration Service (NIS) has announced that its Passport Digital Platform will experience temporary disruptions due to routine system maintenance scheduled to take place from 12:00 a.m. on 12 December to 6:00 a.m. on 14 December 2025 (GMT).",
				"language": "en-GB",
				"libraryCatalog": "Daily Times",
				"place": "Nigeria",
				"publicationTitle": "Daily Times",
				"url": "https://dailytimesng.com/nis-announces-temporary-disruptions-on-passport-digital-platform/",
				"attachments": [
					{
						"title": "Snapshot",
	...
	{
		"type": "web",
		"url": "https://dailytimesng.com/nysc-redesigns-saed-introduces-ai-digital-skills-to-tackle-youth-unemployment/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "NYSC redesigns SAED, introduces AI, digital skills to tackle youth unemployment",
				"creators": [
					{
						"firstName": "Ukpono",
						"lastName": "Ukpong",
				...
				"date": "2025-12-14",
				"ISSN": "0331-2739",
				"abstractNote": "Daily Times is Nigeria trusted source for breaking news, politics, business, sports, entertainment, and analysis bringing you stories that matter.",
				"language": "en-GB",
				"libraryCatalog": "Daily Times",
				"place": "Nigeria",
				"publicationTitle": "Daily Times",
