{
	...
	"lastUpdated": "2017-03-14 05:05:19"
}
...
FW.Scraper({
itemType         : 'blogPost',
detect           : FW.Url().match(/\/(news|culture-2|audio|music|op-ed-2|exclusives|controversial|interview|featured|events|film)\//),
title            : FW.Xpath('//meta[@property="og:title"]/@content').text(),
attachments      : [{ url: FW.Url(),
  title:  "OkayAfrica snapshot",
  type: "text/html" }],
...
hooks : { "scraperDone": function  (item,doc,url) {   // use single-field for generic authorship
	if (item.creators[0].lastName == "okayafrica") {
		delete item.creators[0].firstName;
		item.creators[0].lastName = "OkayAfrica";
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Xpath('//section[contains(concat(" ", normalize-space(@class), " "), " article-tiles ")]'), // category pages
choices          : {
  titles  :  FW.Xpath('//h3[@class="entry-title"]').text().trim(), // standard bricks
  urls    :  FW.Xpath('//main/article/a').key("href").trim()
}/*, {    // below paths needed to handle main page multi, but doesn't play nice (low priority)
  titles  :  FW.Xpath('//header[@class="entry-title"]/h3').text().trim(), // news bricks on home page
  urls    :  FW.Xpath('//article[contains(concat(" ", normalize-space(@class), " "), " newsbrief ")]/a').key("href").trim()
}, {
  titles  :  FW.Xpath('//h2[@class="entry-title"]/a').text().trim(), // hero banner on home page
...
choices          : {
  titles  :  FW.Xpath('//div[@class="results infinite-scroll"]/p/a/span/span[@class="search-result__title serif"]').text().trim(),
  urls    :  FW.Xpath('//div[@class="results infinite-scroll"]/p/a').key("href").trim()
}
});
...
var testCases = [
	{
		"type": "web",
		"url": "http://www.okayafrica.com/news/guess-whos-coming-to-dinner-richard-taittinger-gallery-nyc-african-artists-exhibition/",
		"items": [
			{
				"itemType": "blogPost",
				"title": "12 African Artists Explore \"The Burden Of 'Africanness'\" In NYC Exhibition",
				"creators": [
					{
						"firstName": "Jennifer",
				...
				"date": "2015-07-27T17:20:37-04:00",
				"abstractNote": "A new exhibition at Richard Taittinger Gallery in NYC explores the \"burden of 'Africanness'\" through the work of 12 African artists.",
				"blogTitle": "OkayAfrica",
				"language": "en-US",
				"url": "http://www.okayafrica.com/news/guess-whos-coming-to-dinner-richard-taittinger-gallery-nyc-african-artists-exhibition/",
				"attachments": [
	...
	{
		"type": "web",
		"url": "http://www.okayafrica.com/interview/nazlee-arbee-uses-music-form-mobilization/",
		"items": [
			{
				"itemType": "blogPost",
				"title": "South African Artist Nazlee Arbee Uses Music as a Form of Mobilization in Their New Music Video",
				"creators": [
					{
						"firstName": "Chaze",
						"lastName": "Matakala",
				...
				"date": "2017-02-08T12:18:38-04:00",
				"abstractNote": "South African artist and activist Nazlee Arbee speaks to OkayAfrica on the creative and spiritual processes for \"The Wake Up Call.\"",
				"blogTitle": "OkayAfrica",
				"language": "en-US",
				"url": "http://www.okayafrica.com/interview/nazlee-arbee-uses-music-form-mobilization/",
				"attachments": [
	...
	{
		"type": "web",
		"url": "http://www.okayafrica.com/exclusives/okayafricas-100-women/",
		"items": [
			{
				"itemType": "blogPost",
				"title": "OkayAfrica’s 100 Women",
				"creators": [
					{
						"lastName": "OkayAfrica",
						"creatorType": "author",
				...
				"date": "2017-03-06T16:58:58-04:00",
				"abstractNote": "OkayAfrica's 100 Women is our first annual look at the women making an impact on the African continent and in the diaspora. From the biggest names in culture to young up-and-comers, we've got 'em.",
				"blogTitle": "OkayAfrica",
				"language": "en-US",
				"url": "http://www.okayafrica.com/exclusives/okayafricas-100-women/",
				"attachments": [
	...
	{
		"type": "web",
		"url": "http://www.okayafrica.com/?s=1%3A54",
		"items": "multiple"
	}
]
/** END TEST CASES **/
