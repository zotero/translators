{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2012-02-23 05:46:07"
}
...
function detectWeb(doc, url) { if(!Zotero.Utilities.xpath(doc,'//body/*[not(self::iframe) and not(self::script)]').length) return null;
...
choices          : {
  titles :  FW.Xpath('//div[@class="resultBlock"]/div[@class="resultDisplay"]/h2/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="resultBlock"]/div[@class="resultDisplay"]/h2/a').key("href")
}
});
