{
	...
	"translatorType": 4,
	"browserSupport": "gcsv",
	"lastUpdated": "2013-09-27 00:43:40"
}
...
date             : FW.Xpath('//span[@class="posted-and-updated"]').text().match(/\d{2}\/\d{2}\/\d{2}/),
...
choices          : {
  titles :  FW.Xpath('//a[@class="find" and contains(@href, ".html")]').text().trim(),
  urls    :  FW.Xpath('//a[@class="find" and contains(@href, ".html")]').key("href")
}
});
