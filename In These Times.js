{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2013-02-24 23:41:51"
}
...
FW.Scraper({
itemType : 'blogPost',
detect : FW.Xpath('//div[@class="content-body"]/h1[@class="blog-headline"]'),
title : FW.Xpath('//h1[@class="blog-headline"]').text().trim(),
attachments : {
  url : FW.Url(),
...
date : FW.Xpath('//div[@class="datetime"]').text(),
publicationTitle : FW.Xpath('//h1[contains(@class, "masthead")]').text().prepend("In These Times Blog - ")
});

/** Articles */
FW.Scraper({
itemType : 'magazineArticle',
detect : FW.Xpath('//div[@class="content-body"]/h1[@class="article-headline"]'),
...
FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//div[@class="content-holder"]/h1[@class="blog-headline"]'),
choices : {
  titles : FW.Xpath('//h1[@class="blog-headline"]/a').text(),
  urls : FW.Xpath('//h1[@class="blog-headline"]/a').key('href').text()
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
		...
		"items": [
			{
				...
				"publicationTitle": "In These Times Blog - Working In These Times",
