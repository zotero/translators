{
	...
	"translatorType": 4,
	"browserSupport": "gcsv",
	"lastUpdated": "2016-03-25 20:33:48"
}
...
function scrapeArticle(doc, url) {
	...
	// example article: BB 2014, 3; CR 2016, 28; WRP 2016, 420
	var temp = ZU.xpath(doc, "//div[@class='docLayoutTitel']/h3/following-sibling::br");
	if (temp.length>0) {	// yes, there is additional information, then grab from another source (which unfortunately differs sometimes)
		var temp2 = ZU.xpathText(doc, "//div[@class='docLayoutTitel']/h3/a");
		if (temp2 == null) {
			temp2 = ZU.xpathText(doc, "//div[@class='docLayoutTitel']/h3")
		}
		if (temp2 != null) item.title = temp2;
	}
...
var testCases = [
		...
		"items": [
			{
				...
				"pages": "259-298",
				"publicationTitle": "Zeitschrift für die gesamte Strafrechtswissenschaft, Wenn Sie den Link markieren (linke Maustaste gedrückt halten) können Sie den Link mit der rechten Maustaste kopieren und in den Browser oder in Ihre Favoriten als Lesezeichen einfügen.",
				"attachments": [
					{
						"title": "Snapshot"
					}
		...
		"items": [
			{
				...
				"libraryCatalog": "Juris",
				"pages": "293-299",
				"publicationTitle": "Archiv für Presserecht, Wenn Sie den Link markieren (linke Maustaste gedrückt halten) können Sie den Link mit der rechten Maustaste kopieren und in den Browser oder in Ihre Favoriten als Lesezeichen einfügen.",
				"attachments": [
					{
						"title": "Snapshot"
					}
		...
		"items": [
			{
				...
				"libraryCatalog": "Juris",
				"pages": "431-442",
				"publicationTitle": "Baurecht, Wenn Sie den Link markieren (linke Maustaste gedrückt halten) können Sie den Link mit der rechten Maustaste kopieren und in den Browser oder in Ihre Favoriten als Lesezeichen einfügen.",
				"attachments": [
					{
						"title": "Snapshot"
					}
		...
		"items": [
			{
				...
				"libraryCatalog": "Juris",
				"pages": "1283-1294",
				"publicationTitle": "Betriebs-Berater, Wenn Sie den Link markieren (linke Maustaste gedrückt halten) können Sie den Link mit der rechten Maustaste kopieren und in den Browser oder in Ihre Favoriten als Lesezeichen einfügen.",
				"attachments": [
					{
						"title": "Snapshot"
					}
	...
	{
		"type": "web",
		"url": "http://www.juris.de/jportal/portal/t/cdt/page/jurisw.psml?doc.hl=1&doc.id=jzs-CR-2016-01-0028-2-A-04&documentnumber=2&numberofresults=2&doctyp=Zeitschrift&showdoccase=1&doc.part=H&paramfromHL=true#focuspoint",
		"items": [
			{
				"itemType": "journalArticle",
				"title": "Der Entwurf für eine EU-Richtlinie über Netz- und Informationssicherheit (NIS)",
				"creators": [
					{
						"firstName": "Marco",
						"lastName": "Gercke",
				...
				"libraryCatalog": "Juris",
				"pages": "28-30",
				"publicationTitle": "Computer und Recht, Wenn Sie den Link markieren (linke Maustaste gedrückt halten) können Sie den Link mit der rechten Maustaste kopieren und in den Browser oder in Ihre Favoriten als Lesezeichen einfügen.",
				"attachments": [
					{
						"title": "Snapshot"
					}
