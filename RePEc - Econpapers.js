{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2012-01-30 22:37:39"
}
...
attachments : [{ url: FW.Xpath('//p/a[contains(@href, "scripts/redi")]').text().trim(),
  title: "RePEc PDF",
...
url: FW.Xpath('//p/a[contains(@href, "scripts/redi")]').text().trim(),
		...
		"items": [
			{
				...
				"attachments": [
					...
					{
						"url": "http://www.fareastjournals.com/archive_detail.aspx?jid=18&aid=13",
						"title": "RePEc PDF",
						"type": "application/pdf"
					},
					{
