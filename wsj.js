{
	...
	"lastUpdated": "2014-01-02 17:44:59"
}
...
date             : FW.Xpath('//header/small[@class="post-time"]').text().remove(/.+?\s[ap]m/),
ISSN			 : "0099-9660",
publicationTitle : FW.Xpath('//span[@class="logo"]/a/img/@title').text().prepend("WSJ Blogs - ")
}); 
