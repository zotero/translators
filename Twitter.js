{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2011-07-17 21:27:05"
}
...
attachments      : { url : FW.Url() ,
			 ...
			 type : "text/html" },
blogTitle	 : FW.Xpath('//div[contains(@class,"permalink-tweet")]')
						.key('data-screen-name'),
...
date         : FW.Xpath('//div[contains(@class,"permalink-tweet")]//a[@class="tweet-timestamp"]/span[2]/attribute::*[2]')
						.text(),
