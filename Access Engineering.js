...
function scrape(doc, url) {
	...
	translator.setHandler("itemDone", function (obj, item) {
		// Edition
		let edition = ZU.xpathText(
			doc,
			'//meta[@name="citation_edition"]/@content'
		);
...
var testCases = [
	...
	{
		type: "web",
		url: "https://www.accessengineeringlibrary.com/content/book/9781259860386/chapter/chapter12?implicit-login=true",
		items: [
			{
		...
		items: [
			{
				itemType: "journalArticle",
				title:
					"Open Channel Flow Calculations with the Manning Equation using Excel Spreadsheets",
				creators: [
					{
						firstName: "P. E.",
				...
				date: "2014-02-01",
				abstractNote:
					"<p>This tutorial teaches the Manning equation and its use for uniform open channel flow calculations, including the hydraulic radius, Manning roughness coefficient, and normal depth. There are example problems and illustrations show how to use spreadsheets for the calculations.</p>",
				language: "en",
				libraryCatalog: "www.accessengineeringlibrary.com",
				url: "https://www.accessengineeringlibrary.com/content/tutorial/T0002_Open_Channel_Flow_Calculations_with_the_Manning_Equation",
				attachments: [
		...
		items: [
			{
				...
				date: "2014",
				abstractNote:
					"<p>This video shows how to cut text through a plane with Combine/Subtract.</p>",
				language: "en",
				libraryCatalog: "www.accessengineeringlibrary.com",
