{
	"translatorID": "760c401d-0d0e-4eaa-98dc-79e32ef8fb19",
	"label": "GameZone",
	"creator": "czar",
	"target": "^https?://(www\\.)?gamezone\\.com",
	"minVersion": "3.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2017-03-12 07:55:31"
}
...
attachments      : [{ url: FW.Url(),
  ...
  type: "text/html" }],
creators         : FW.Xpath('//div[@class="bio-content"]/strong/a').text().cleanAuthor("author"),
date             : FW.Xpath('//div[@class="meta-time"]').text().replace(/(news|reviews)\\/,""),
blogTitle        : "GameZone",
language         : "en-US",
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/search\?/), // search
choices          : {
  titles  :  FW.Xpath('//div[@class="article-item"]/h4/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="article-item"]/h4/a').key("href")
  }
});

FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/\/games\//), // individual game categories
choices          : {
  titles  :  FW.Xpath('//div[@class="article-content"]/h4/a').text().trim(),
...
var testCases = [
	{
		"type": "web",
		"url": "http://www.gamezone.com/news/long-awaited-mother-localization-coming-to-north-america-as-earthbound-beginnings-3417565",
		"items": [
			{
				"itemType": "blogPost",
				"title": "Long-awaited Mother localization coming to North America as Earthbound Beginnings",
				"creators": [
					{
						"firstName": "Jose",
						"lastName": "Cardoso",
				...
				"date": "Jun 15, 2015 at 12:05 am",
				"abstractNote": "Tucked away in the pre-show leading up to the Nintendo World Championships 2015, Nintendo made an unforseen announcement that, frankly, was un...",
				"blogTitle": "GameZone",
				"language": "en-US",
				"url": "http://www.gamezone.com/news/long-awaited-mother-localization-coming-to-north-america-as-earthbound-beginnings-3417565",
				"attachments": [
	...
	{
		"type": "web",
		"url": "http://www.gamezone.com/reviews/review-earthbound-returns-to-prove-why-it-s-one-of-the-greatest-rpgs-of-all-time",
		"items": [
			{
				"itemType": "blogPost",
				"title": "Review: EarthBound returns to prove why it's one of the greatest RPGs of all time",
				"creators": [
					{
						"firstName": "David",
						"lastName": "Sanchez",
				...
				"abstractNote": "There&#39;s a reason so many people are in love with EarthBound. Sure, you could chalk it up to pure, unbridled nostalgia, but doing so would ...",
				"blogTitle": "GameZone",
				"language": "en-US",
				"shortTitle": "Review",
				"url": "http://www.gamezone.com/reviews/review-earthbound-returns-to-prove-why-it-s-one-of-the-greatest-rpgs-of-all-time",
	...
	{
		"type": "web",
		"url": "http://www.gamezone.com/search?utf8=%E2%9C%93&q=earthbound",
		"items": "multiple"
	},
	{
		"type": "web",
		"url": "http://www.gamezone.com/games/earthbound",
		"items": "multiple"
	}
]
/** END TEST CASES **/
