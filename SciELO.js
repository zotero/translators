{
	...
	"translatorType": 4,
	"browserSupport": "gcs",
	"lastUpdated": "2011-09-22 22:56:53"
}
...
creators : FW.Xpath('//meta[@name="citation_authors"]').key("content").text().split(";").cleanAuthor("author", useComma="true"),
...
FW.MultiScraper({
itemType : 'multiple',
detect : FW.Url().match(/search\.scielo\.org\/index\.php/),
choices : {
