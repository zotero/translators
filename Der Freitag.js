{
	...
	"translatorType": 4,
	"browserSupport": "gcsb",
	"lastUpdated": "2012-06-24 16:27:11"
}
...
abstractNote	 : FW.Xpath('//article[@id="principal"]/p[@class="description"]').text().trim(),
tags			 : FW.Xpath('//div[@class="keywords text"]/a').text().trim(),
language		 : "de-DE", 
ISSN			 : "0945-2095",
...
choices          : {
  titles :  FW.Xpath('//dl[@class="searchResults"]/dt[@class="contenttype-freitag-article-article"]/a').text().trim(),
  urls    :  FW.Xpath('//dl[@class="searchResults"]/dt[@class="contenttype-freitag-article-article"]/a').key("href")
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
