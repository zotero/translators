{
	"translatorID": "9b4b15ba-af65-4b95-bb9a-de5332a3d865",
	"label": "P.M. News",
	"creator": "VWF",
	"target": "^https?://www\\.?.pmnewsnigeria\\.com/",
	"minVersion": "5.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2025-12-15 13:53:22"
}
...
function detectWeb(doc, url) {
	...
	if (text(doc, 'div.main-article h1')) {
		return 'newspaperArticle';
	}
...
async function scrape(doc, url) {
	...
	function splitAuthors(nameStr) {
		...
		for (let p of parts) {
			...
			if (np && !/^(agency|press|desk|news|gazette|reporter|editor|nigeria|staff|bureau)$/i.test(np)) {
				cleaned.push(np);
			}
		}
		return cleaned;
	...
	if (data) {
		...
		if (data.author) {
			...
			for (let a of authors) {
				...
				if (
					name
					&& !/agency|press|desk|news|gazette|reporter|editor|nigeria|staff|bureau/i.test(name.toLowerCase())
	...
	if (!item.publicationTitle) {
		item.publicationTitle = 'P.M. News';
	}
...
var testCases = [
	{
		"type": "web",
		"url": "https://pmnewsnigeria.com/2025/12/15/fubara-supreme-court-rules-president-can-declare-emergency-rule-suspend-elected-officials/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "Fubara: Supreme Court rules president can declare emergency rule, suspend elected officials - P.M. News",
				"creators": [
					{
						"firstName": "Michael",
						"lastName": "Adesina",
				...
				"date": "2025-12-15",
				"ISSN": "2006-7968",
				"abstractNote": "The Supreme Court has ruled that the President can declare a state of emergency in any state to prevent a breakdown of law and order or a slide into chaos.",
				"language": "en-US",
				"libraryCatalog": "P.M. News",
				"place": "Nigeria",
				"publicationTitle": "P.M. News",
				"shortTitle": "Fubara",
				"url": "https://pmnewsnigeria.com/2025/12/15/fubara-supreme-court-rules-president-can-declare-emergency-rule-suspend-elected-officials/",
				"attachments": [
					{
	...
	{
		"type": "web",
		"url": "https://pmnewsnigeria.com/2016/01/24/nigerian-navy-repatriates-24-illegal-gabonees-immigrants/",
		"items": [
			{
				"itemType": "newspaperArticle",
				"title": "Nigerian Navy repatriates 24 illegal Gabonees immigrants",
				"creators": [],
				"ISSN": "2006-7968",
				"abstractNote": "The Eastern Naval Command of the Nigerian Navy on Sunday at the Shore line jetty, Calabar, repatriated 24 illegal immigrants from Gabon. The immigrants were among 41 foreigners in a transport vessel, AV Agamba impounded by the Navy during a routine patrol on Thursday. Also aboard the vessel were no fewer than 200 Nigerians. Commodore […]",
				"libraryCatalog": "P.M. News",
				"place": "Nigeria",
				"publicationTitle": "P.M. News",
				"url": "https://pmnewsnigeria.com/2016/01/24/nigerian-navy-repatriates-24-illegal-gabonees-immigrants/",
