{
	...
	"lastUpdated": "2012-11-18 15:48:06"
}
...
FW.Scraper({
itemType : 'artwork',
detect : FW.Xpath('//td[@id="fileinfotpl_art_title"]'),
title : FW.Xpath('//td[@id="fileinfotpl_art_title"]/following-sibling::td').text().trim().remove(/\n.+/g),
attachments : [{
  url : FW.Url(),
...
date : FW.Xpath('//tr/td[@id="fileinfotpl_date"]/following-sibling::td/text()').text(),
...
FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//ul[@class="gallery"]'),
choices : {
  titles : FW.Xpath('//ul[@class="gallery"]//div[@class="gallerytext"]').text(),
  urls : FW.Xpath('//ul[@class="gallery"]//a[@class="image"]').key('href').text()
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
		...
		"items": [
			{
				...
				"title": "English: Dos Congresos Square, Buenos Aires, Argentrina",
				"libraryCatalog": "Wikimedia Commons",
				"accessDate": "CURRENT_TIMESTAMP",
				"shortTitle": "English"
			}
